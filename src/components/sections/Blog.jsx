...
const Blog = () => {
  return (
    <section
      ...
      id="blog"
    >
      <SectionHeader title={"Blog."} subtitle={"Exploring Ideas, Sharing Insights: The World of Tech Through My Lens"} />
          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <p className="text-lg text-gray-500 dark:text-gray-400">
                Looks like I'm still crafting exciting articles for you! Check
                back soon for amazing content.
              </p>
            </div>
          </div>
        )}
