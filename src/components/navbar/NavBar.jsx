...
const NavBar = () => {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-1 w-2/3 transform -translate-x-1/2 rounded-lg z-50 transition-all duration-300 ${isScrolled
    ...
    >
      <nav className="max-w-screen-xl mx-auto px-4 md:px-8 py-4 flex justify-between items-center no-print">
        ...
        <ul
          className={`md:flex items-center space-x-6 ${isMobileMenuOpen
